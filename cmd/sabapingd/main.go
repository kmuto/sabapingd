...
import (
	...
	"github.com/mackerelio-labs/sabapingd/internal/diskcache"
	"github.com/mackerelio-labs/sabapingd/internal/mackerel"
	"github.com/mackerelio-labs/sabapingd/internal/sender"
	"github.com/mackerelio-labs/sabapingd/internal/sendqueue"
	"github.com/mackerelio-labs/sabapingd/internal/ticker"
	"github.com/mackerelio-labs/sabapingd/internal/worker"
)
...
func main() {
	...
	var err error
	conf, err = config.Init(ctx, configFilename)
	if err != nil {
		slog.ErrorContext(ctx, "failed parse config", slog.String("error", err.Error()))
		os.Exit(1)
	}
	...
	if err = client.CreateGraphDefs(ctx, mackerel.GraphDefs); err != nil {
